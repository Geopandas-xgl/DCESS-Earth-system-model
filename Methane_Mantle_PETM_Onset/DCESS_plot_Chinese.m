...
text_norm(0.6+0.09,0.85+0.03,"\fontname{Times}CO2\_\fontname{SimSun}幔源 \fontname{Times}(-5 ‰)",9);
% rectangle_norm([0.6,0.7,0.08,0.08],FaceColor(2,:));
line_norm([0.6,0.6+0.08],[0.7+0.08/2,0.7+0.08/2],EdgeColor(2),1.2);
text_norm(0.6+0.09,0.7+0.03,"\fontname{Times}CH4\_\fontname{SimSun}水合物 \fontname{Times}(-60 ‰)",9);
% rectangle_norm([0.6,0.55,0.08,0.08],FaceColor(3,:));
line_norm([0.6,0.6+0.08],[0.55+0.08/2,0.55+0.08/2],EdgeColor(3),1.2);
text_norm(0.6+0.09,0.55+0.03,"\fontname{Times}CH4\_\fontname{SimSun}热变质 \fontname{Times}(-45 ‰)",9);
...
text(7,-3,{"   \fontname{SimSun}底栖","\fontname{SimSun}有孔虫灭绝"},"Color","#E88471","FontName","Times","FontSize",10,"Interpreter","tex");
...
%% 
print(gcf,"Figure\DCESS_PETM_中文","-dpng","-r600");
%% 
