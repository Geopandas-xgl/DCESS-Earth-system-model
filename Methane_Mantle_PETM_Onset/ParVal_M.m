...
global rcp rno rcop rnp rcd rda rca minO minN rDNno3 rDNnh4 rRBonh4...
    rRBnnh4 rSRh2s rSRnh4 rRBoh2s LfLL LfHL lmdcar lmdorg lmdcorg rf methc13 mixc13 lipc13 mettc13
%-----
...
mettc13 = -45;                        %methermogenic methane: -45;
mixc13 = -5;                          %del13C of mixture between organic matter and mantle
lipc13 = -5;                          %del13C associated with lip 
%************************
...
% Ocean
global So Cao Pint DICint ALKint DelCO3LL DelCO3HL TSL TSH NPPIL NPPIH korgb
%-----
...
%******************************************************************
wfac      = 0.65*(2/2);                    % multiple of PI weathering
wfacP     = 0.8468*(2/1); %0.65;           % multiple of PI weathering 
wfacC     = 1.0086*(2/2);
